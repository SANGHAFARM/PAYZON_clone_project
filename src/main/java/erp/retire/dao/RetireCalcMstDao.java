...
import erp.retire.model.RetireCalcMst;
...
public class RetireCalcMstDao {
	...
	public void insert(Connection conn, RetireCalcMst mst) throws SQLException {
	...
	public RetireCalcMst selectById(Connection conn, int retireCalcMstId) throws SQLException {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
	...
	public RetireCalcMst selectByUniqueKey(Connection conn, int empId, String calcType, java.util.Date calcStartDate,
	...
	public List<RetireCalcMst> selectByEmpId(Connection conn, int empId) throws SQLException {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
			...
			List<RetireCalcMst> result = new ArrayList<>();
			while (rs.next()) {
	...
	public int update(Connection conn, RetireCalcMst mst) throws SQLException {
		PreparedStatement pstmt = null;
		try {
	...
	// ResultSet 데이터를 RetireCalcMst 객체로 변환
	// 코드 중복 방지를 위한 공통 매핑 객체 반환
	private RetireCalcMst makeRetireCalcMstFromResultSet(ResultSet rs) throws SQLException {
		RetireCalcMst mst = new RetireCalcMst();
