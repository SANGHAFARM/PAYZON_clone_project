...
public class DailyWorkEmployeeListService {
	...
	public List<DailyWorkRecordDto> getDailyWorkEmployee(DailyWorkRecordSearchRequest req) {
		List<DailyWorkRecordDto> list = null;
		try(Connection conn = ConnectionProvider.getConnection()){
			list = dailyWorkRecordDao.selectDailyWorkRecord(conn, req);
			return list;
