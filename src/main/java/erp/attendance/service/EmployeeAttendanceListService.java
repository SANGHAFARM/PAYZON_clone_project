...
public class EmployeeAttendanceListService {
	...
	public List<AttendanceEmployeeRecordDto> getAttendanceEmployeeRecord(AttendanceEmployeeSearchRequest req){
		List<AttendanceEmployeeRecordDto> list = null;
		try(Connection conn = ConnectionProvider.getConnection()){
			list = employeeAttendanceDao.selectAttendanceEmployee(conn, req);
			return list;
