...
public class EmployeeAttendanceInsertService {
    ...
    public Integer insert(AttendanceRecordInsertRequest req) {
    ...
    private EmployeeAttendance toEmployeeAttendance(AttendanceRecordInsertRequest req, int empId, AttendanceItem attendanceItem) {
