...
public class CertIssueDao {
    ...
    public void insert(Connection conn, CertIssue cert) throws SQLException {
    ...
    public CertIssue selectById(Connection conn, int certIssueId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
    ...
    public List<CertIssue> selectByEmpId(Connection conn, int empId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            String sql = "SELECT CERT_ISSUE_ID, EMP_ID, CERT_DOC_NO, CERT_TYPE, PURPOSE, CERT_MEMO, "
            ...
            List<CertIssue> result = new ArrayList<>();
            while (rs.next()) {
    ...
    public int update(Connection conn, CertIssue cert) throws SQLException {
        PreparedStatement pstmt = null;
        try {
    ...
    // ResultSet 데이터를 CertIssue 객체로 변환
    // 코드 중복 방지를 위한 공통 매핑 처리
    private CertIssue makeCertIssueFromResultSet(ResultSet rs) throws SQLException {
        CertIssue cert = new CertIssue();
