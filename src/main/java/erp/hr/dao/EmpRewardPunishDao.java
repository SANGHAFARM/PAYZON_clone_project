...
import erp.hr.model.EmpRewardPunish;
...
public class EmpRewardPunishDao {
    ...
    public void insert(Connection conn, EmpRewardPunish rp) throws SQLException {
    ...
    public EmpRewardPunish selectById(Connection conn, int rpId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
    ...
    public List<EmpRewardPunish> selectByEmpId(Connection conn, int empId) throws SQLException {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            String sql = "SELECT RP_ID, EMP_ID, RP_TYPE, RP_NAME, RP_AUTHORITY, RP_DATE, RP_CONTENT, NOTE "
            ...
            List<EmpRewardPunish> result = new ArrayList<>();
            while (rs.next()) {
    ...
    public int update(Connection conn, EmpRewardPunish rp) throws SQLException {
        PreparedStatement pstmt = null;
        try {
    ...
    // ResultSet 데이터를 EmpRewardPunish 객체로 변환
    // 코드 중복 방지를 위한 공통 매핑 처리
    private EmpRewardPunish makeEmpRewardPunishFromResultSet(ResultSet rs) throws SQLException {
        EmpRewardPunish rp = new EmpRewardPunish();
