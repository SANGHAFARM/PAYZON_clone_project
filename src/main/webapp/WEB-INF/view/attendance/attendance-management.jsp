							...
							<c:forEach var="employee" items="${employees}">
								<tr>
									...
									<td>
										...
										href="${pageContext.request.contextPath}/attendance/attendance-management.do?employeeId=${employee.employeeId}&status=${status}&keyword=${keyword}#attendance-record-modal-${employee.employeeId}">管理</a>
									</td>
								</tr>
							</c:forEach>
				...
				<section class="attendance-editor">
					...
					<form id="attendance-form"
						...
						<label><span>勤怠項目</span> <select name="attendanceItemId">
							...
							class="period-inputs"> <input type="date" lang="ja-JP"
