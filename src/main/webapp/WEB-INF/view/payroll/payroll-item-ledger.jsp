...
<body>
	...
	<main class="page-content payment-item-ledger-page">
		...
		<section class="ledger-card">
			...
			<div class="ledger-actions"><a href="#approvalSettingModal" class="button button-primary">결제란 설정</a><a href="${pageContext.request.contextPath}/payroll/register.do" class="button button-outline">급여대장 목록</a></div>
		</section>
	</main>
	<section id="approvalSettingModal" class="modal-layer" role="dialog" aria-modal="true" aria-labelledby="approvalModalTitle">
		...
		<div class="modal-dialog approval-modal">
			...
			<form method="post" action="${pageContext.request.contextPath}/payroll/item-ledger/approval-setting.do">
