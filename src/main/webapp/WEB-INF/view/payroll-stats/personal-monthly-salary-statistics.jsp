...
<body>
	...
	<main class="page-content annual-stat-page personal-salary-page personal-monthly-page">
		<header class="page-heading"><div><p>給与統計</p><h1>月別個人給与統計</h1></div></header>
		<section class="content-card">
			...
			<section class="chart-panel">
				<div class="section-title-row"><h2 class="sr-only">月別個人給与チャート</h2><div class="chart-legend"><span><i class="net-legend"></i>差引支給額</span><span><i class="deduction-legend"></i>控除額</span></div></div>
					...
					<c:forEach var="stat" items="${monthlySalaryStats}">
						<div class="annual-chart__item" tabindex="0">
							<div class="annual-chart__plot salary-chart__plot">
								<!-- チャート率（Java Serviceで0円のときに10％の高さを与えるように設定された値をそのまま使用） -->
	...
	<div id="employeeSelectModal" class="css-modal" role="dialog" aria-modal="true" aria-labelledby="employee-modal-title">
		...
		<section class="css-modal__dialog employee-modal">
			<header class="css-modal__header"><h2 id="employee-modal-title">個人給与照会社員選択</h2><a href="#_" class="css-modal__close" aria-label="閉じる">×</a></header>
