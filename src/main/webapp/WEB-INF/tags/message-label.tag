...
<c:choose>
	...
	<c:when test="${value eq '휴가항목이 추가되었습니다.'}">休暇項目を追加しました。</c:when>
	<c:when test="${value eq '휴가항목이 수정되었습니다.'}">休暇項目を修正しました。</c:when>
	<c:when test="${value eq '휴가항목이 삭제되었습니다.'}">休暇項目を削除しました。</c:when>
	<c:when test="${value eq '근태항목이 추가되었습니다.'}">勤怠項目を追加しました。</c:when>
	<c:when test="${value eq '근태항목이 수정되었습니다.'}">勤怠項目を修正しました。</c:when>
	<c:when test="${value eq '근태항목이 삭제되었습니다.'}">勤怠項目を削除しました。</c:when>
	<c:when test="${value eq '근태그룹이 수정되었습니다.'}">勤怠グループを修正しました。</c:when>
	<c:when test="${value eq '근태그룹이 삭제되었습니다.'}">勤怠グループを削除しました。</c:when>
	<c:when test="${value eq '휴가 적용 종료일은 시작일보다 빠를 수 없습니다.'}">休暇の適用終了日は開始日より前に設定できません。</c:when>
	<c:when test="${value eq '지급항목이 추가되었습니다.'}">支給項目を追加しました。</c:when>
	<c:when test="${value eq '지급항목이 수정되었습니다.'}">支給項目を修正しました。</c:when>
	<c:when test="${value eq '지급항목이 삭제되었습니다.'}">支給項目を削除しました。</c:when>
	<c:when test="${value eq '공제항목이 추가되었습니다.'}">控除項目を追加しました。</c:when>
	<c:when test="${value eq '공제항목이 수정되었습니다.'}">控除項目を修正しました。</c:when>
	<c:when test="${value eq '공제항목이 삭제되었습니다.'}">控除項目を削除しました。</c:when>
